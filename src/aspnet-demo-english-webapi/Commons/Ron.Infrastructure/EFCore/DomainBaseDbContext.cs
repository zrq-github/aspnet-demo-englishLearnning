...
namespace Ron.Infrastructure.EFCore;

/// <summary>
/// 领域实现的的数据库基础
/// </summary>
public abstract class DomainBaseDbContext : DbContext
{
    private readonly IMediator? _mediator;

    protected DomainBaseDbContext(DbContextOptions options, IMediator? mediator) : base(options)
    {
        _mediator = mediator;
    }
    ...
    public override async Task<int> SaveChangesAsync(bool acceptAllChangesOnSuccess, CancellationToken cancellationToken = default)
    {
        ...
        softDeletedEntities.ForEach(e => Entry(e).State = EntityState.Detached); 
